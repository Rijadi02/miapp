    ...
    @section('content')
        ...
        <section class="page-header">
            <div class="page-header__top">
                <div class="page-header-bg" style="background-image: url({{asset('assetsFront/images/backgrounds/derset.jpg')}})"></div>
                                ...
                                <div class="popular-tours__single">
                                    <div class="popular-tours__img">
                                        ...
                                        <div class="popular-tours__icon">
                                            ...
                                            <a class="d-none-mobile" href="fb-messenger://share/?link=<?php echo $url ?>&redirect_uri=<?php echo $url ?>&app_id=1266109583813461" target="_blank">
